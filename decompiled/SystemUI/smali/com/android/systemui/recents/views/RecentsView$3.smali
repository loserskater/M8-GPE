...
.method constructor <init>(Lcom/android/systemui/recents/views/RecentsView;Lcom/android/systemui/recents/model/Task;Lcom/android/systemui/recents/misc/SystemServicesProxy;Landroid/app/ActivityOptions;Z)V
    ...
    iput-object p2, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$task:Lcom/android/systemui/recents/model/Task;

    iput-object p3, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$ssp:Lcom/android/systemui/recents/misc/SystemServicesProxy;

    iput-object p4, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$launchOpts:Landroid/app/ActivityOptions;

    iput-boolean p5, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$lockToTask:Z
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$ssp:Lcom/android/systemui/recents/misc/SystemServicesProxy;
    ...
    iget-object v2, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$launchOpts:Landroid/app/ActivityOptions;
    ...
    iget-object v2, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$task:Lcom/android/systemui/recents/model/Task;
    ...
    iget-object v3, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$task:Lcom/android/systemui/recents/model/Task;

    iget-object v3, v3, Lcom/android/systemui/recents/model/Task;->activityLabel:Ljava/lang/String;

    iget-object v4, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$launchOpts:Landroid/app/ActivityOptions;
    ...
    iget-object v0, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$launchOpts:Landroid/app/ActivityOptions;

    if-nez v0, :cond_0

    iget-boolean v0, p0, Lcom/android/systemui/recents/views/RecentsView$3;->val$lockToTask:Z
