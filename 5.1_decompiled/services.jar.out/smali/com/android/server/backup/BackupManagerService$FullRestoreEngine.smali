...
.method private isRestorableFile(Lcom/android/server/backup/BackupManagerService$FileMetadata;)Z
    ...
    const-string v3, "Dropping cache file path "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p1, Lcom/android/server/backup/BackupManagerService$FileMetadata;->path:Ljava/lang/String;
    ...
    const-string v3, "Dropping no_backup file path "
    ...
    const-string v3, "Dropping invalid path "
...
.method readAppManifest(Lcom/android/server/backup/BackupManagerService$FileMetadata;Ljava/io/InputStream;)Lcom/android/server/backup/BackupManagerService$RestorePolicy;
    ...
    const-string v20, "   readAppManifest() looking for "
    ...
    const-string v20, " already consumed"
...
.method public restoreOneFile(Ljava/io/InputStream;)Z
    ...
    const-string v7, "Reading tar header for restoring file"
    ...
    const-string v7, "No [more] data for this package; tearing down"
    ...
    const-string v8, "  copying to restore agent: "
...
.method skipTarPadding(JLjava/io/InputStream;)V
    ...
    const-string v4, "RestoreEngine"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Skipping tar padding: "
