...
.method deliverAlarmsLocked(Ljava/util/ArrayList;J)V
    ...
    invoke-virtual {v2, v11}, Landroid/os/WorkSource;->get(I)I

    move-result v2

    iget-object v3, v6, Lcom/android/server/AlarmManagerService$Alarm;->workSource:Landroid/os/WorkSource;

    invoke-virtual {v3, v11}, Landroid/os/WorkSource;->getName(I)Ljava/lang/String;

    move-result-object v3

    invoke-static {v1, v2, v3}, Landroid/app/ActivityManagerNative;->noteWakeupAlarm(Landroid/app/PendingIntent;ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/AlarmManagerService;->removeImpl(Landroid/app/PendingIntent;)V
