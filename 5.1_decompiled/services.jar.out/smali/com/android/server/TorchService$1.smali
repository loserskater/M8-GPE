...
.method constructor <init>(Lcom/android/server/TorchService;ILandroid/os/IBinder;)V
    ...
    iput p2, p0, Lcom/android/server/TorchService$1;->val$cameraId:I

    iput-object p3, p0, Lcom/android/server/TorchService$1;->val$token:Landroid/os/IBinder;
...
.method public binderDied()V
    ...
    invoke-static {v0}, Lcom/android/server/TorchService;->access$000(Lcom/android/server/TorchService;)Landroid/util/SparseArray;
    ...
    iget v3, p0, Lcom/android/server/TorchService$1;->val$cameraId:I
    ...
    iget-object v2, p0, Lcom/android/server/TorchService$1;->val$token:Landroid/os/IBinder;

    iget v3, p0, Lcom/android/server/TorchService$1;->val$cameraId:I

    # invokes: Lcom/android/server/TorchService;->removeCameraUserLocked(Landroid/os/IBinder;I)V
    invoke-static {v0, v2, v3}, Lcom/android/server/TorchService;->access$300(Lcom/android/server/TorchService;Landroid/os/IBinder;I)V
