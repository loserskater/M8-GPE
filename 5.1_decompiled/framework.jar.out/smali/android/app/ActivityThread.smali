...
.field static final BUILD_TEST_KEY:Z
...
.field public static final PERF_LOG:Z

.field public static final PERF_TAG:Ljava/lang/String; = "Perf"
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/app/ActivityThread;->DEBUG_AM:Z

    sget-boolean v0, Landroid/app/ActivityThread;->DEBUG_AM:Z

    sput-boolean v0, Landroid/app/ActivityThread;->PERF_LOG:Z
...
.method private attach(Z)V
    ...
    :try_start_0
    sget-boolean v3, Landroid/app/ActivityThread;->PERF_LOG:Z
    ...
    const-string v5, "attach ApplicationThread="
...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    invoke-static {v2, v4, v5, v7}, Landroid/os/Debug;->startMethodTracingDdms(IIZI)V
    ...
    :try_start_2
    invoke-interface/range {v27 .. v27}, Landroid/net/IConnectivityManager;->getDefaultProxy()Landroid/net/ProxyInfo;
...
.method private handleBindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    invoke-virtual {v5, v8}, Landroid/content/Intent;->setExtrasClassLoader(Ljava/lang/ClassLoader;)V
    ...
    :try_start_1
    iget-boolean v5, p1, Landroid/app/ActivityThread$BindServiceData;->rebind:Z
    ...
    invoke-virtual {v4, v5}, Landroid/app/Service;->onBind(Landroid/content/Intent;)Landroid/os/IBinder;

    move-result-object v0

    sget-boolean v5, Landroid/app/ActivityThread;->PERF_LOG:Z
    ...
    invoke-interface {v5, v8, v9, v0}, Landroid/app/IActivityManager;->publishService(Landroid/os/IBinder;Landroid/content/Intent;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v4, v5}, Landroid/app/Service;->onRebind(Landroid/content/Intent;)V
    ...
    invoke-interface {v5, v8, v9, v10, v11}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_1
    ...
    invoke-virtual {v5, v4, v1}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    invoke-direct {v5, v8, v1}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handleCreateBackupAgent(Landroid/app/ActivityThread$CreateBackupAgentData;)V
    ...
    iget-object v0, v0, Landroid/app/ActivityThread$CreateBackupAgentData;->appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    const-string v19, "Asked to instantiate non-matching package "
    ...
    const-string v18, "Can\'t reach package manager"

    move-object/from16 v0, v18

    invoke-static {v15, v0, v9}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    iget-object v15, v0, Landroid/app/ActivityThread$CreateBackupAgentData;->appInfo:Landroid/content/pm/ApplicationInfo;

    move-object/from16 v0, p1

    iget-object v0, v0, Landroid/app/ActivityThread$CreateBackupAgentData;->compatInfo:Landroid/content/res/CompatibilityInfo;
    ...
    iget-object v13, v12, Landroid/app/LoadedApk;->mPackageName:Ljava/lang/String;

    if-nez v13, :cond_1

    const-string v15, "ActivityThread"

    const-string v18, "Asked to create backup agent for nonexistent package"
    ...
    iget-object v7, v15, Landroid/content/pm/ApplicationInfo;->backupAgentName:Ljava/lang/String;

    if-nez v7, :cond_3

    move-object/from16 v0, p1

    iget v15, v0, Landroid/app/ActivityThread$CreateBackupAgentData;->backupMode:I
    ...
    :cond_2
    const-string v7, "android.app.backup.FullBackupAgent"
    ...
    iget-object v15, v0, Landroid/app/ActivityThread;->mBackupAgents:Landroid/util/ArrayMap;
    ...
    invoke-virtual {v4}, Landroid/app/backup/BackupAgent;->onBind()Landroid/os/IBinder;
    :try_end_1
    ...
    invoke-interface {v15, v13, v5}, Landroid/app/IActivityManager;->backupAgentCreated(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_2
    ...
    :cond_5
    :try_start_3
    invoke-virtual {v12}, Landroid/app/LoadedApk;->getClassLoader()Ljava/lang/ClassLoader;
    ...
    invoke-static {v0, v12}, Landroid/app/ContextImpl;->createAppContext(Landroid/app/ActivityThread;Landroid/app/LoadedApk;)Landroid/app/ContextImpl;

    move-result-object v8

    invoke-virtual {v8, v4}, Landroid/app/ContextImpl;->setOuterContext(Landroid/content/Context;)V

    invoke-virtual {v4, v8}, Landroid/app/backup/BackupAgent;->attach(Landroid/content/Context;)V

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v16

    invoke-virtual {v4}, Landroid/app/backup/BackupAgent;->onCreate()V

    sget-boolean v15, Landroid/app/ActivityThread;->PERF_LOG:Z
    ...
    invoke-virtual {v15, v13, v4}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_3
    ...
    const-string v19, "Agent threw during creation: "
    ...
    const-string v19, "Unable to create BackupAgent "
...
.method private handleCreateService(Landroid/app/ActivityThread$CreateServiceData;)V
    ...
    iget-object v4, v0, Landroid/app/ActivityThread$CreateServiceData;->info:Landroid/content/pm/ServiceInfo;

    iget-object v4, v4, Landroid/content/pm/ServiceInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    move-object/from16 v0, p1

    iget-object v5, v0, Landroid/app/ActivityThread$CreateServiceData;->compatInfo:Landroid/content/res/CompatibilityInfo;

    move-object/from16 v0, p0

    invoke-virtual {v0, v4, v5}, Landroid/app/ActivityThread;->getPackageInfoNoCheck(Landroid/content/pm/ApplicationInfo;Landroid/content/res/CompatibilityInfo;)Landroid/app/LoadedApk;
    ...
    invoke-static {v0, v13}, Landroid/app/ContextImpl;->createAppContext(Landroid/app/ActivityThread;Landroid/app/LoadedApk;)Landroid/app/ContextImpl;
    ...
    invoke-virtual {v13, v4, v5}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
    ...
    iget-object v6, v0, Landroid/app/ActivityThread$CreateServiceData;->token:Landroid/os/IBinder;
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/app/Service;->attach(Landroid/content/Context;Landroid/app/ActivityThread;Ljava/lang/String;Landroid/os/IBinder;Landroid/app/Application;Ljava/lang/Object;)V
    ...
    sget-boolean v4, Landroid/app/ActivityThread;->PERF_LOG:Z
    ...
    iget-object v4, v0, Landroid/app/ActivityThread;->mServices:Landroid/util/ArrayMap;
    ...
    invoke-interface {v4, v5, v6, v8, v0}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_2
    ...
    invoke-virtual {v4, v2, v12}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    iget-object v6, v0, Landroid/app/ActivityThread$CreateServiceData;->info:Landroid/content/pm/ServiceInfo;
    ...
    invoke-direct {v4, v5, v12}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handleReceiver(Landroid/app/ActivityThread$ReceiverData;)V
    ...
    iget-object v14, v0, Landroid/app/ActivityThread$ReceiverData;->info:Landroid/content/pm/ActivityInfo;

    iget-object v14, v14, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    move-object/from16 v0, p1

    iget-object v15, v0, Landroid/app/ActivityThread$ReceiverData;->compatInfo:Landroid/content/res/CompatibilityInfo;

    move-object/from16 v0, p0

    invoke-virtual {v0, v14, v15}, Landroid/app/ActivityThread;->getPackageInfoNoCheck(Landroid/content/pm/ApplicationInfo;Landroid/content/res/CompatibilityInfo;)Landroid/app/LoadedApk;
    ...
    invoke-virtual {v14, v3}, Landroid/content/Intent;->setExtrasClassLoader(Ljava/lang/ClassLoader;)V

    move-object/from16 v0, p1

    iget-object v14, v0, Landroid/app/ActivityThread$ReceiverData;->intent:Landroid/content/Intent;

    invoke-virtual {v14}, Landroid/content/Intent;->prepareToEnterProcess()V

    move-object/from16 v0, p1

    invoke-virtual {v0, v3}, Landroid/app/ActivityThread$ReceiverData;->setExtrasClassLoader(Ljava/lang/ClassLoader;)V
    ...
    invoke-virtual {v10, v14, v15}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
    ...
    sget-object v14, Landroid/app/ActivityThread;->sCurrentBroadcastIntent:Ljava/lang/ThreadLocal;
    ...
    invoke-virtual {v11, v0}, Landroid/content/BroadcastReceiver;->setPendingResult(Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    invoke-virtual {v11, v14, v15}, Landroid/content/BroadcastReceiver;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V

    sget-boolean v14, Landroid/app/ActivityThread;->PERF_LOG:Z
    ...
    invoke-virtual {v0, v9}, Landroid/app/ActivityThread$ReceiverData;->sendFinished(Landroid/app/IActivityManager;)V
    ...
    const-string v16, "Unable to instantiate receiver "
    ...
    invoke-direct {v14, v15, v8}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v14, v0, Landroid/app/ActivityThread;->mInstrumentation:Landroid/app/Instrumentation;

    invoke-virtual {v14, v11, v8}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v16, "Unable to start receiver "
...
.method private handleServiceArgs(Landroid/app/ActivityThread$ServiceArgsData;)V
    ...
    iget-object v10, v0, Landroid/app/ActivityThread;->mServices:Landroid/util/ArrayMap;

    move-object/from16 v0, p1

    iget-object v11, v0, Landroid/app/ActivityThread$ServiceArgsData;->token:Landroid/os/IBinder;
    ...
    iget-object v10, v0, Landroid/app/ActivityThread$ServiceArgsData;->args:Landroid/content/Intent;
    ...
    invoke-virtual {v7}, Landroid/app/Service;->getClassLoader()Ljava/lang/ClassLoader;
    ...
    iget-boolean v10, v0, Landroid/app/ActivityThread$ServiceArgsData;->taskRemoved:Z
    ...
    iget v11, v0, Landroid/app/ActivityThread$ServiceArgsData;->flags:I

    move-object/from16 v0, p1

    iget v12, v0, Landroid/app/ActivityThread$ServiceArgsData;->startId:I

    invoke-virtual {v7, v10, v11, v12}, Landroid/app/Service;->onStartCommand(Landroid/content/Intent;II)I
    ...
    const-string v12, " onStartCommand wait SharedPreferences apply to disk"
    ...
    iget v13, v0, Landroid/app/ActivityThread$ServiceArgsData;->startId:I

    invoke-interface {v10, v11, v12, v13, v6}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_1
    ...
    :goto_3
    :try_start_2
    invoke-virtual/range {p0 .. p0}, Landroid/app/ActivityThread;->ensureJitEnabled()V
    ...
    invoke-virtual {v10, v13, v14, v15, v0}, Landroid/content/Intent;->toShortString(ZZZZ)Ljava/lang/String;
    ...
    invoke-virtual {v7, v10}, Landroid/app/Service;->onTaskRemoved(Landroid/content/Intent;)V
    :try_end_2
    ...
    iget-object v10, v0, Landroid/app/ActivityThread;->mInstrumentation:Landroid/app/Instrumentation;
    ...
    iget-object v12, v0, Landroid/app/ActivityThread$ServiceArgsData;->args:Landroid/content/Intent;
...
.method private handleStopActivity(Landroid/os/IBinder;ZI)V
    ...
    invoke-direct {v0, v6}, Landroid/app/ActivityThread$StopInfo;-><init>(Landroid/app/ActivityThread$1;)V

    invoke-direct {p0, v2, v0, p2, v3}, Landroid/app/ActivityThread;->performStopActivityInner(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/ActivityThread$StopInfo;ZZ)V
    ...
    sget-boolean v6, Landroid/app/ActivityThread;->DEBUG_AM:Z
    ...
    const-string v8, " handleStopActivity wait SharedPreferences apply to disk"
    ...
    iget-object v6, v2, Landroid/app/ActivityThread$ActivityClientRecord;->state:Landroid/os/Bundle;

    iput-object v6, v0, Landroid/app/ActivityThread$StopInfo;->state:Landroid/os/Bundle;

    iget-object v6, v2, Landroid/app/ActivityThread$ActivityClientRecord;->persistentState:Landroid/os/PersistableBundle;

    iput-object v6, v0, Landroid/app/ActivityThread$StopInfo;->persistentState:Landroid/os/PersistableBundle;

    iget-object v6, p0, Landroid/app/ActivityThread;->mH:Landroid/app/ActivityThread$H;

    invoke-virtual {v6, v0}, Landroid/app/ActivityThread$H;->post(Ljava/lang/Runnable;)Z
...
.method private handleStopService(Landroid/os/IBinder;)V
    ...
    sget-boolean v9, Landroid/app/ActivityThread;->PERF_LOG:Z
    ...
    instance-of v9, v0, Landroid/app/ContextImpl;

    if-eqz v9, :cond_1

    invoke-virtual {v5}, Landroid/app/Service;->getClassName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v8, v9}, Landroid/app/ContextImpl;->scheduleFinalCleanup(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v11, " onDestroy wait SharedPreferences apply to disk"
    ...
    invoke-interface {v9, p1, v10, v11, v12}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    const-string v11, "handleStopService: unable to execute serviceDoneExecuting for "
    ...
    invoke-static {v9, v10, v1}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-virtual {v9, v5, v1}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v11, "Unable to stop service "
    ...
    const-string v11, "handleStopService: exception for "
    ...
    const-string v11, "handleStopService: token="
...
.method private handleUnbindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    invoke-interface {v5, v8, v9, v0}, Landroid/app/IActivityManager;->unbindFinished(Landroid/os/IBinder;Landroid/content/Intent;Z)V
    ...
    const-string v9, "Unable to unbind to service "
...
.method private installContentProviders(Landroid/content/Context;Ljava/util/List;)V
    ...
    const-string/jumbo v2, "publishContentProviders failed, size="
...
.method private performDestroyActivity(Landroid/os/IBinder;ZIZ)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    iget-object v5, v4, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;
    ...
    iget v8, v5, Landroid/app/Activity;->mConfigChangeFlags:I

    or-int/2addr v8, p3

    iput v8, v5, Landroid/app/Activity;->mConfigChangeFlags:I
    ...
    iput-boolean v8, v5, Landroid/app/Activity;->mFinished:Z

    :cond_0
    iget-boolean v5, v4, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z
    ...
    iput-boolean v8, v5, Landroid/app/Activity;->mCalled:Z

    iget-object v5, p0, Landroid/app/ActivityThread;->mInstrumentation:Landroid/app/Instrumentation;

    iget-object v8, v4, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;

    invoke-virtual {v5, v8}, Landroid/app/Instrumentation;->callActivityOnPause(Landroid/app/Activity;)V
    ...
    iget-object v10, v4, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;
    ...
    invoke-static {v9}, Landroid/app/ActivityThread;->safeToComponentShortString(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-direct {v5, v8}, Landroid/util/SuperNotCalledException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v8, v1}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v9, "Unable to pause activity "
    ...
    iput-boolean v5, v4, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z

    :cond_2
    iget-boolean v5, v4, Landroid/app/ActivityThread$ActivityClientRecord;->stopped:Z
    ...
    invoke-virtual {v5}, Landroid/app/Activity;->performStop()V
    :try_end_1
    ...
    iput-boolean v5, v4, Landroid/app/ActivityThread$ActivityClientRecord;->stopped:Z
    ...
    invoke-virtual {v5}, Landroid/app/Activity;->retainNonConfigurationInstances()Landroid/app/Activity$NonConfigurationInstances;

    move-result-object v5

    iput-object v5, v4, Landroid/app/ActivityThread$ActivityClientRecord;->lastNonConfigurationInstances:Landroid/app/Activity$NonConfigurationInstances;
    :try_end_2
    ...
    invoke-virtual {v5, v8}, Landroid/app/Instrumentation;->callActivityOnDestroy(Landroid/app/Activity;)V
    ...
    const-string v9, " did not call through to super.onDestroy()"
    ...
    const-string v9, "Unable to stop activity "
    ...
    const-string v9, "Unable to retain activity "
    ...
    :cond_7
    :try_start_4
    iget-object v5, v4, Landroid/app/ActivityThread$ActivityClientRecord;->window:Landroid/view/Window;

    if-eqz v5, :cond_8

    iget-object v5, v4, Landroid/app/ActivityThread$ActivityClientRecord;->window:Landroid/view/Window;

    invoke-virtual {v5}, Landroid/view/Window;->closeAllPanels()V
    :try_end_4
    ...
    const-string v9, "Unable to destroy activity "
