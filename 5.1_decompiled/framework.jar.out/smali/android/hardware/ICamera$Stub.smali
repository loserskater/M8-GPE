...
.method public static asInterface(Landroid/os/IBinder;)Landroid/hardware/ICamera;
    ...
    :cond_0
    const-string v1, "android.hardware.ICamera"
    ...
    check-cast v0, Landroid/hardware/ICamera;

    goto :goto_0

    :cond_1
    new-instance v0, Landroid/hardware/ICamera$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/ICamera$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
