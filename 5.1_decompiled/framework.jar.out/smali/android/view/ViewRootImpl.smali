...
.method private drawSoftware(Landroid/view/Surface;Landroid/view/View$AttachInfo;IIZLandroid/graphics/Rect;)Z
    ...
    const-string v7, "Could not lock surface after unlockCanvasAndPost failed"
...
.method private enableHardwareAcceleration(Landroid/view/WindowManager$LayoutParams;)V
    ...
    iput-boolean v12, v11, Landroid/view/View$AttachInfo;->mHardwareAccelerated:Z

    iget-object v11, p0, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;

    const/4 v12, 0x0

    iput-boolean v12, v11, Landroid/view/View$AttachInfo;->mHardwareAccelerationRequested:Z
    ...
    const v11, -0x1d4e35d8

    if-eq v9, v11, :cond_2

    const v11, 0x699c138d

    if-eq v9, v11, :cond_2

    const v11, -0x21cc63ee
    ...
    iget v11, p1, Landroid/view/WindowManager$LayoutParams;->privateFlags:I
    ...
    :cond_8
    sget-boolean v11, Landroid/view/HardwareRenderer;->sRendererDisabled:Z

    if-eqz v11, :cond_9

    sget-boolean v11, Landroid/view/HardwareRenderer;->sSystemRendererDisabled:Z
    ...
    invoke-virtual {v11}, Landroid/view/HardwareRenderer;->destroy()V

    :cond_a
    iget-object v8, p1, Landroid/view/WindowManager$LayoutParams;->surfaceInsets:Landroid/graphics/Rect;
    ...
    :goto_4
    iget v11, p1, Landroid/view/WindowManager$LayoutParams;->format:I
    ...
    iget-object v12, p0, Landroid/view/ViewRootImpl;->mContext:Landroid/content/Context;

    invoke-static {v12, v10}, Landroid/view/HardwareRenderer;->create(Landroid/content/Context;Z)Landroid/view/HardwareRenderer;

    move-result-object v12

    iput-object v12, v11, Landroid/view/View$AttachInfo;->mHardwareRenderer:Landroid/view/HardwareRenderer;
    ...
    invoke-virtual {v11, v12}, Landroid/view/HardwareRenderer;->setName(Ljava/lang/String;)V

    iget-object v11, p0, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;

    iget-object v12, p0, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;

    const/4 v13, 0x1

    iput-boolean v13, v12, Landroid/view/View$AttachInfo;->mHardwareAccelerationRequested:Z

    iput-boolean v13, v11, Landroid/view/View$AttachInfo;->mHardwareAccelerated:Z
...
.method doProcessInputEvents()V
    ...
    sget-boolean v1, Landroid/view/ViewRootImpl;->PERFORMANCE_LOG_ENABLED:Z
    ...
    invoke-virtual {v1, v4}, Landroid/view/ViewRootImpl$ViewRootHandler;->removeMessages(I)V
    ...
    const-string v1, "doProcessInputEvents"

    invoke-direct {p0, v1, v2, v3}, Landroid/view/ViewRootImpl;->logHeavyAction(Ljava/lang/String;J)V
