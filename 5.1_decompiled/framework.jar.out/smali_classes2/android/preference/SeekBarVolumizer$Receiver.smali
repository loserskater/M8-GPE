...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v3}, Landroid/preference/SeekBarVolumizer;->access$900(I)Z
    ...
    invoke-static {v5}, Landroid/preference/SeekBarVolumizer;->access$1100(Landroid/preference/SeekBarVolumizer;)Landroid/media/AudioManager;
    ...
    invoke-static {v6}, Landroid/preference/SeekBarVolumizer;->access$1000(Landroid/preference/SeekBarVolumizer;)I
    ...
    invoke-static {v5}, Landroid/preference/SeekBarVolumizer;->access$1200(Landroid/preference/SeekBarVolumizer;)Landroid/preference/SeekBarVolumizer$H;
    ...
    # getter for: Landroid/preference/SeekBarVolumizer;->mAudioManager:Landroid/media/AudioManager;
    invoke-static {v6}, Landroid/preference/SeekBarVolumizer;->access$1100(Landroid/preference/SeekBarVolumizer;)Landroid/media/AudioManager;
    ...
    invoke-static {v5, v6}, Landroid/preference/SeekBarVolumizer;->access$1302(Landroid/preference/SeekBarVolumizer;I)I

    :cond_4
    iget-object v5, p0, Landroid/preference/SeekBarVolumizer$Receiver;->this$0:Landroid/preference/SeekBarVolumizer;

    # getter for: Landroid/preference/SeekBarVolumizer;->mAffectedByRingerMode:Z
    invoke-static {v5}, Landroid/preference/SeekBarVolumizer;->access$1400(Landroid/preference/SeekBarVolumizer;)Z
