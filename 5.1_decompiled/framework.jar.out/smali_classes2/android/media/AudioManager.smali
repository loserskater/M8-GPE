...
.field public static final BEATBOX_BT_SPEAKER:I = 0x7d2

.field public static final BEATS_PILL_BT_SPEAKER:I = 0x7d0

.field public static final BEATS_WIRELESS_BT_HEADSET:I = 0x7d1
...
.field public static final EXTRA_SOUNDEFFECT_ID:Ljava/lang/String; = "com.htc.EXTRA_SOUNDEFFECT_ID"
...
.field public static final GENERIC_BT_DEVICE:I = 0x7da
...
.field public static final GLOBAL_SOUNDEFFECT_DTS:I = 0x385
...
.field static final GLOBAL_SOUNDEFFECT_LOUDNESS:I = 0x324
...
.field public static final GLOBAL_SOUNDEFFECT_SRS:I = 0x386
...
.field private static final HAS_BEATS_SPEAKER:I

.field public static final HEADSET_ERROR:I = -0x3e9

.field public static final HTC_MIDTIER_HEADSET:I = 0x3ef

.field public static final HTC_STOCK_EARBUDS:I = 0x3ee
...
.field public static final SOLO_BEATS_HEADSET2_0:I = 0x3ed

.field public static final SOUNDEFFECT_CHANGED:Ljava/lang/String; = "com.htc.intent.action.SOUNDEFFECT_CHANGED"
...
.field public static final UR_BEATS_HEADSET2_0:I = 0x3ec
...
.field public static isSupportBeats:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v4, Landroid/media/AudioManager;->isSupportBeats:Z

    const-string v0, "VIDEO_SOUNDEFFECT\\=(ON|OFF)"

    invoke-static {v0}, Ljava/util/regex/Pattern;->compile(Ljava/lang/String;)Ljava/util/regex/Pattern;

    move-result-object v0

    sput-object v0, Landroid/media/AudioManager;->mPattern:Ljava/util/regex/Pattern;

    const-string v0, "htc.audio.global.speaker"

    invoke-static {v0, v3}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Landroid/media/AudioManager;->HAS_BEATS_SPEAKER:I
...
.method public static hasBeatsSpeaker()Z
    .locals 2

    const/4 v0, 0x1

    sget v1, Landroid/media/AudioManager;->HAS_BEATS_SPEAKER:I
...
.method public adjustSuggestedStreamVolume(III)V
    ...
    const-string v5, ", suggestedStreamType:"
...
.method public forceSoundEffect(I)V
    .locals 5
    ...
    invoke-interface {v1, p1, v2, v3, v4}, Landroid/media/IAudioService;->forceSoundEffect(ILandroid/os/IBinder;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in forceSoundEffect"
...
.method public getSoundEffect()I
    ...
    :try_start_0
    invoke-interface {v2}, Landroid/media/IAudioService;->getSoundEffect()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "Dead object in getSoundEffect"
...
.method public requestAudioFocusForCall(II)V
    ...
    const-string v3, "requestAudioFocusForCall, streamType = "
...
.method public restoreSoundEffect()V
    .locals 4
    ...
    invoke-interface {v1, v2}, Landroid/media/IAudioService;->restoreSoundEffect(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in restoreSoundEffect"
...
.method public setBluetoothScoOn(Z)V
    ...
    const-string v4, "setBluetoothScoOn, on="
    ...
    const-string v3, "persist.sys.audiomanager.on"
...
.method public setParameters(Ljava/lang/String;)V
    ...
    sget-object v5, Landroid/media/AudioManager;->mPattern:Ljava/util/regex/Pattern;
    ...
    const-string v6, "notifyVideoEvent"
    ...
    invoke-interface {v3, v5, v6, v4}, Landroid/media/IAudioService;->notifyVideoEvent(Landroid/os/IBinder;Ljava/lang/String;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v6, "Dead object in setParameters"
    ...
    const-string v6, "keyValuePairs is null"
...
.method public setSpeakerphoneOn(Z)V
    ...
    const-string v4, "setSpeakerphoneOn, on="
